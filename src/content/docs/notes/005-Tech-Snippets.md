...
- [7-Zip Snippets](../005-computer-snippets-7-zip) - [7-Zip
  Snippets](id:3432e62b-4989-4e1d-8441-4369599139ba)
- [asdf Snippets](../005-computer-snippets-asdf) - [asdf
  Snippets](id:45f7089c-d0e6-4383-8aa1-66c10a02101f)
- [Astro Snippets](../005-computer-snippets-astro) - [Astro
  Snippets](id:618c93ca-18c9-41bb-8ea4-2cee102b674b)
- [Atuin Snippets](../005-computer-snippets-atuin) - [Atuin
...
- [AWS CLI Snippets](../005-computer-snippets-amazon-aws-cli) - [Amazon
  AWS CLI Snippets](id:b4358cc2-2fc2-493c-bb65-101b671fad72)
- [Azure CLI Snippets](../005-computer-snippets-azure-cli) - [Azure CLI
  Snippets](id:fda4035c-d254-4532-9833-952d8041038b)
- [Azure Export for Terraform aztfexport
  Snippets](../005-computer-snippets-azure-export-for-terraform-aztfexport) -
  [Azure Export For Terraform aztfexport
  Snippets](id:bd7db893-9230-4178-8f68-10e6436651ff)
- [Bash Snippets](../005-computer-snippets-bash) - [Bash
  Snippets](id:157bbbb3-97c0-45b4-8f72-bbf0d1e3a934)
- [bat Snippets](../005-computer-snippets-bat) - [bat
  Snippets](id:c112c6bb-197d-40c0-8f8a-1facb0092a38)
- [Chocolatey - Windows Package
  Manager](../005-computer-snippets-chocolatey) - [Chocolatey Windows
  Package Manager](id:989f29a2-f03f-4725-912b-f68a8fe0cb67)
- [ClamAV Snippets](../005-computer-snippets-clamav) - [ClamAV
  Snippets](id:548a26ed-b2b5-497f-9957-cf70fbe1703b)
- [curl Snippets](../005-computer-snippets-curl) - [curl
  Snippets](id:eeea3c28-1982-465b-9fd0-a0af71b779e1)
- [DevPod snippets - reproducible developer
  environments](../005-computer-snippets-devpod) - [DevPod Snippets -
...
- [Emacs eshell Snippets](../005-computer-snippets-emacs-eshell) -
...
- [Email](../005-computer-snippets-email) - [Email
...
- [fd find Snippets](../005-computer-snippets-fd-find) - [fd find
  Snippets](id:2a52ab2a-7857-4b15-8f5a-dbeffc23f6eb)
...
- [Fish shell Snippets](../005-computer-snippets-linux-fish) - [Fish
  Shell Snippets](id:b8c0b8a1-f1ed-4f17-bf4b-8c03498760ff)
- [Flatpak Snippets](../005-computer-snippets-flatpak) - [Flatpak
  Snippets](id:8d596332-95f9-4f9a-b7a9-cfe859af98e5)
- [Fold and fmt Snippets](../005-computer-snippets-fold-fmt) - [Fold and
  fmt snippets](id:2e37e08e-4764-4714-8dc9-0b557f3c7a0a)
...
- [GitHub CLI Snippets](../005-computer-snippets-github-cli) - [GitHub
  CLI Snippets](id:a3c30671-2f49-4952-9cb4-a5b4087bf8b3)
- [Git Snippets](../005-computer-snippets-git) - [Git
...
- [Grep, ripgrep rg
  Snippets](../005-computer-snippets-grep-ripgrep-rg) - [Grep, ripgrep
  rg Snippets](id:6e48cb97-82cb-40b9-ad4e-0ecc70d13b7b)
- [grex Snippets](../005-computer-snippets-grex) - [grex
  Snippets](id:4bb2d854-a1f0-44c8-8bfe-f3de31658ab2)
- [Helix Snippets](../005-computer-snippets-helix) - [Helix
  Snippets](id:0ad986a2-9bec-4d2c-8687-f91af216c662)
- [Helm Snippets](../005-computer-snippets-helm) - [Helm
...
- [Java Snippets](../005-computer-snippets-java) - [Java
...
- [Linux Clipboard
  xsel](../005-computer-snippets-linux-clipboard-xsel) - [Linux
  Clipboard Xsel](id:c3c2298e-3279-4514-a111-ec2bd3373193)
- [Lisp Snippets](../005-computer-snippets-lisp) - [Lisp
  Snippets](id:6fb9219e-4a52-4870-94e9-8c64a997c58f)
- [Locate Snippets](../005-computer-snippets-locate) - [Locate
...
- [Lynx Snippets](../005-computer-snippets-lynx) - [Lynx
  Snippets](id:43c90be8-d1c8-4212-8827-5cb03220c234)
- [Make Snippets](../005-computer-snippets-make) - [Make
  Snippets](id:55fa5347-938b-43d8-9c98-3d1a8d28595d)
- [Markdown](../005-computer-snippets-markdown) - [Markdown
  Snippets](id:f2162753-fa54-47d9-bd7d-b5ead55b40ee)
- [Mermaid Diagrams Snippets](../005-computer-snippets-mermaid) -
...
- [mpocs Snippets](../005-computer-snippets-mprocs) - [mprocs
...
- [Neovim Snippets](../005-computer-snippets-neovim) - [Neovim
  Snippets](id:14f691d1-6ce6-4765-8fed-4fcee1ea410a)
- [Nix Snippets](../005-computer-snippets-nix) - [Nix
  Snippets](id:70ae2a4f-f340-45b8-b3eb-63d2faa0e987)
- [npm - Node Package
  Manager](../005-computer-snippets-node-package-manager-npm-npx) -
  [Node Package Manager - npm](id:445b9e5b-6983-4422-8f86-9e19f5933f7a)
- [Nushell Snippets](../005-computer-snippets-nushell) - [Nushell
  Snippets](id:8f076960-3e23-4f1c-a53e-239ec3a61cb4)
- [nvm - Node Version
  Manager](../005-computer-snippets-nvm-node-version-manager) - [Node
...
- [PlantUML Snippets](../005-computer-snippets-plantuml) - [PlantUML
...
- [Power Fx Snippets](../005-computer-snippets-powerfx) - [Power Fx
...
- [Python Anaconda and
  Conda](../005-computer-snippets-python-anaconda) - [Python and
  Anaconda Snippets](id:09101af3-7da0-4433-b8b4-c1df997fcd91)
- [Python Debugging Snippets](../005-computer-snippets-python-debug) -
...
- [Python uv Snippets](../005-computer-snippets-python-uv) - [Python uv
  Snippets](id:cee07d5c-6a4c-4d91-9120-2e731b26fe7c)
- [Regex Regular Expression Snippets](../005-computer-snippets-regex) -
...
- [Scoop Windows Package Manager](../005-computer-snippets-scoop) -
  [Scoop Windows Package Manager
  Snippets](id:fed06507-bb32-40a4-90c3-a490d2f0302f)
- [sha256sum Snippet](../005-computer-snippets-sha256sum) - [sha256sum
  Snippet](id:d478f1a2-d9a2-4d97-b69b-1fdaea0a09ae)
- [SQL Snippets](../005-computer-snippets-sql) - [SQL
  Snippets](id:7aacccab-4571-4fbe-a61a-67236aaf2d60)
- [SSH Snippets](../005-computer-snippets-ssh) - [SSH
  Snippets](id:df000228-d572-4544-8dcb-86f94b1cd346)
- [Stow Snippets](../005-computer-snippets-stow) - [Stow GNU
  Snippets](id:b70edd4e-9022-467b-ba9a-600b39b72853)
- [systemd-journal Snippets](../005-computer-snippets-systemd-journal) -
  [systemd-journal Snippets](id:bd625f38-5dee-464e-bf0f-da6b57b0c52b)
- [Television Snippets](../005-computer-snippets-television) -
  [Television Snippets](id:464e217b-0754-456e-9b6b-d3d954917af5)
- [tmux Snippets](../005-computer-snippets-tmux) - [tmux
  Snippets](id:65e276bc-3efb-403c-a0fd-7e92905daa83)
- [Topgrade Snippets](../005-computer-snippets-topgrade) - [Topgrade
  Snippets](id:4853e88e-b18c-4c9e-a9c7-12b75d52d78f)
- [Vagrant Snippets](../005-computer-snippets-vagrant) - [Vagrant
  Snippets](id:f6eac044-2ed3-4bbb-8578-61d95ba6ba22)
- [Veracrypt Snippets](../005-computer-snippets-veracrypt) - [Veracrypt
  Snippets](id:15f6ccb4-c2c4-492f-bbed-5baef9050f30)
- [Vim Snippets](../005-computer-snippets-vim) - [Vim
  Snippets](id:0615a025-93dc-4dbf-b835-dbedc5fadbc7)
- [Windows cmd Snippets](../005-computer-snippets-cmd) - [windows cmd
  Snippets](id:5823f5a9-3c82-453a-bad3-e659009dee7a)
- [Windows Snippets](../005-computer-snippets-windows) - [Windows
  Snippets](id:cba87902-6edd-4f82-8071-24d8902da403)
- [Windows WSL Snippets](../005-computer-snippets-windows-wsl) -
  [Windows WSL Snippets](id:135e45be-b456-4c86-a5cb-fee47064b77a)
- [Wine Snippets](../005-computer-snippets-wine) - [Wine
  Snippets](id:d74e20b9-f1b8-4d8d-8747-71366f9ab90a)
- [winget Windows Package Manager](../005-computer-snippets-winget) -
...
- [Zoxide Snippets](../005-computer-snippets-zoxide) - [Zoxide
  Snippets](id:6796a6b4-fa8d-47e9-ac81-5c602c9a439d)

### Linux

- [APT Advanced Package Tool
  Snippets](../005-computer-snippets-linux-apt) - [APT Advanced Package
  Tool Snippets](id:80abb3ba-7e85-4ef4-8a87-f6e2f9b8d3cb)
- [pacman - Arch Linux](../005-computer-snippets-pacman) - [pacman
  Snippets](id:ede4ca2a-ec67-4c86-ab79-71cc7a62584f)
- [Linux Snippets](../005-computer-snippets-linux) - [Linux
  Snippets](id:3aca5424-540c-4f65-a7ca-079fd5e94a99)
  - [Useful Linux Snippets from
    History](../005-computer-snippets-linux-history-me) - [Useful Linux
