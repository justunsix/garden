...
- [airtest](https://pypi.org/project/airtest/) - UI Test Automation
  Framework for Games and Apps on Android/iOS/Windows/Linux
...
- [Pyinstaller](https://pypi.org/project/pyinstaller/) - Bundles Python
  application and all its dependencies into a single package so user can
  run without Python interpreter or other modules
...
- [Awesome Python - curated list of awesome Python frameworks,
  ...
  - [GitHub - vinta/awesome-python: An opinionated list of awesome
    Python frameworks, libraries, software and
    resources.](https://github.com/vinta/awesome-python)
- [PyPI Package Statistics and Analytics](https://pepy.tech/) - download
  amounts for libraries
- [Python Package Index (PyPI)](https://pypi.org/) - library install,
  documentation
