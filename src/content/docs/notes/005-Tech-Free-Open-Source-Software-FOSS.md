...
title: Free and/or Open Source Software (FOSS)
---
...
- [Cockpit](https://github.com/cockpit-project/cockpit) - web based
  ...
  users
- [croc](https://github.com/schollz/croc) - Easily and securely send
...
- [eSpeak NG Text-to-Speech](https://github.com/espeak-ng/espeak-ng) -
  speech synthesizer, TTS that supports more than hundred languages and
  accents.
...
- [grex](https://github.com/pemistahl/grex) - Generate a matching
  regular expression from the test cases you provide, also has Rust
...
- [Kdenlive](https://kdenlive.org/) - Video Editor, Can also do music
  editing and output.
- [Kokoro
  TTS](https://github.com/nazdridoy/kokoro-tts?tab=readme-ov-file) - CLI
  text-to-speech tool using the Kokoro model, supporting multiple
  languages, voices (with blending), and various input formats including
...
- [MaryTTS (Multimodal Interaction
  Architecture)](https://github.com/marytts/marytts) - multilingual
  text-to-speech (TTS) synthesis system written in pure java
...
- [MLflow](https://github.com/mlflow/mlflow) - AI engineering platform
  for agents, LLMs, and ML models. MLflow enables teams of all sizes to
  debug, evaluate, monitor, and optimize AI applications while
  controlling costs and managing access to models and data. Can be used
...
- [Piper](https://github.com/OHF-Voice/piper1-gpl) - A fast and local
  neural text-to-speech (TTS) engine that embeds espeak-ng for
  phonemization.
...
- [Worktrunk](https://worktrunk.dev/) - Git worktree management for
...
- Ubuntu is either LTS or latest version
- mise is [mise-end-place](https://mise.jdx.dev/) dev tools CLI
...
- [All my Open Source App Alternatives - r/freesoftware -
  Reddit](https://www.reddit.com/r/freesoftware/comments/15cp6ff/all_my_open_source_app_alternatives/)
...
- [Fossify Apps](https://github.com/FossifyOrg) are good alternatives
  for common apps

App → Alternative

- Birthday Remember → [Birday](https://github.com/m-i-n-a-r/birday)
- Calculator → [OpenCalc](https://github.com/clementwzk/OpenCalc)
- Calendar → [Etar](https://github.com/Etar-Group/Etar-Calendar)
- Camera → [FadCam](https://github.com/anonfaded/FadCam), [GrapheneOS
  Camera](https://github.com/GrapheneOS/Camera)
- Citymapper (transit) →
  [Transportr](https://github.com/grote/Transportr)
- Clock → [Chrono](https://github.com/vicolo-dev/chrono), [Fossify
  Clock](https://github.com/FossifyOrg/Clock)
- Contact → [Connect You](https://github.com/Bnyro/ConnectYou), [Fossify
...
- File explorer → [Material
  Files](https://github.com/zhanghai/MaterialFiles), [Fossify File
  Manager](https://github.com/FossifyOrg/File-Manager)
- GoodReads →
  [Openreads](https://github.com/mateusz-bak/openreads-android)
- Google Authenticator →
  [Aegis](https://github.com/beemdevelopment/Aegis)
- Google Chrome →
  [Fennec](https://f-droid.org/en/packages.md.mozilla.fennec_fdroid/)
- Google Docs → [Librera
...
- Note → [QuillPad](https://github.com/quillpad/quillpad)
...
- Torrent Manager → [Transdroid](https://github.com/erickok/transdroid)
