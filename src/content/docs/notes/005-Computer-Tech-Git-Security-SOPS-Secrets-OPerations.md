...
title: "Securing Git Secrets, SOPS: Secrets OPerations"
---
...
- Recommended keys to use are AWS KMS, GCP KMS, Azure Key Vault, or PGP.
  AWS Key management service is demonstrated in to the source video.
  Hashicorp Vault and `age` are also supported
