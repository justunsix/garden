...
- Canvas pros and cons
  ...
  - Gaps and alternatives:
    ...
    - Time to build - use reusable components, containers, generate apps
      from images/figma file/API
    - Delegation - use with data model design
    - Limited UX controls, though purposely limited for accessibility -
      use custom Power Apps Custom Framework (PCF) with Typescript
...
- Can be limited by licensing for calls. Consider logic apps for high
  volume of calls
...
- ETL tool to extract data, tranform data, and load to destination like
  Dataverse
- Use DAX language

#### Scalable Data

Evaluate security, capacity, complexity to choose data sources. Common
ones are:
