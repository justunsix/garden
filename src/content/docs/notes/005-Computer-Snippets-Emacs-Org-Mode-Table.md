...
GitHub](https://github.com/james-stoup.md-mode-table-tutorial). Examples
below are [by james-stoup and under GPL-3.0
license](https://github.com/james-stoup.md-mode-table-tutorial?tab=readme-ov-file)
