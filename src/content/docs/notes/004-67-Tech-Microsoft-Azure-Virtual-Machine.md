...
- Add metrics in the explorer and change types of charts and aggregation
  type like Avg, Min, Max
...
- Set up a data collection rule (DCR) to collect Linux VM syslog data
  and view log data in log analytics using Kusto Query Language (KQL)
